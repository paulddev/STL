...
v.push_back(n);         n을 뒤에 추가
v.pop_back();           마지막 원소 삭제
v.clear();              vector 초기화
v.size();               vector의 크기
v.empty();              vector가 비어있으면 true / false
v.front();              vector의 첫 번째 원소
v.back();               vector의 마지막 원소
v.insert(v.begin(), 3, 1); vector의 첫 번째 원소 앞에 1을 3개 삽입
v.erase(v.begin() + 2);    vector의 첫 번째 원소에서 2칸 떨어진 원소를 삭제
*/
